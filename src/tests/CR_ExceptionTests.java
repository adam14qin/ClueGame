...
public class CR_ExceptionTests {
	...
	public void testBadColumns() throws BadConfigFormatException, FileNotFoundException {
		...
		board.setConfigFiles("CR_ClueLayoutBadColumns.csv", "CR_ClueLegend.txt", "SSAL_Weapons.txt", "SSAL_Players.txt");
	...
	public void testBadRoom() throws BadConfigFormatException, FileNotFoundException {
		Board board = Board.getInstance();
		board.setConfigFiles("CR_ClueLayoutBadRoom.csv", "CR_ClueLegend.txt", "SSAL_Weapons.txt", "SSAL_Players.txt");
		board.loadRoomConfig();
		board.loadBoardConfig();
	}
	...
	public void testBadRoomFormat() throws BadConfigFormatException, FileNotFoundException {
		Board board = Board.getInstance();
		board.setConfigFiles("CR_ClueLayout.csv", "CR_ClueLegendBadFormat.txt", "SSAL_Weapons.txt", "SSAL_Players.txt");
		board.loadRoomConfig();
	}
